...
typedef struct {
	...
	char tc_no[12]; // Abone TC Kimlik Numarasý

	char isim[20]; // Abone Ýsmi

	char soyisim[30]; // Abone Soyismi

	char yas[4]; // Abone Yaþý

	char adres[100]; // Abone Adresi



	char tel_no[15]; // Telefon Numarasý

	date ilk_tarih; // Telefon Numarasý Ýlk Verilme Tarihi



	char op_ad[15]; // Mevcut Operatör Ýsmi

	date tarife_bas; // Operatör Tarife Baþlangýcý

	date tarife_son; // Operatör Tarife Sonu

	char kampanya[30]; // Operatör Mevcut Kampanyasý



	char eski_op1[15]; // Eski Operatör 1 Ýsmi

	date op1_baslangic; // Eski Operatör 1 Tarife Baþlangýcý

	date op1_bitis; // Eski Operatör 1 Tarife Sonu

	char eski_op2[15]; // Eski Operatör 2 Ýsmi

	date op2_baslangic; // Eski Operatör 2 Tarife Baþlangýcý
